...
namespace FutureConnection.Infrastructure.Migrations
{
    ...
    [Migration("20260324063417_ExpandDatabase")]
            ...
            modelBuilder.Entity("FutureConnection.Core.Entities.FAQ", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6d2f48a3-1602-4717-bf29-7ccb7aaf7be6"),
                            Answer = "Use multi-factor authentication.",
                            Category = "Security",
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9177),
                            DisplayOrder = 1,
                            IsActive = true,
                            IsDeleted = false,
                            Question = "How do I secure my neural link?",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9178)
                        },
                        new
                        {
                            Id = new Guid("5d0615f1-c077-4f50-850e-4dd4bbc5dbd4"),
                            Answer = "It uses high-frequency analysis.",
                            Category = "General",
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9188),
                            DisplayOrder = 2,
                            IsActive = true,
                            IsDeleted = false,
                            Question = "What is the Smart Matching algorithm?",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9188)
                        });
                });
            ...
            modelBuilder.Entity("FutureConnection.Core.Entities.Policy", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9134),
                            IsActive = true,
                            IsDeleted = false,
                            Title = "Privacy Shield Protocol",
                            Type = "privacy",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9134),
                            Version = "1.0.0"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9142),
                            IsActive = true,
                            IsDeleted = false,
                            Title = "Terms of System Operation",
                            Type = "terms",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(9142),
                            Version = "1.0.0"
                        });
                });
            ...
            modelBuilder.Entity("FutureConnection.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(8977),
                            Description = "Full system administration access.",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(8977)
                        },
                        new
                        {
                            Id = new Guid("b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e"),
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(8984),
                            Description = "Can post jobs, manage applications, and hire freelancers.",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Employer",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(8985)
                        },
                        new
                        {
                            Id = new Guid("c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f"),
                            CreatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(8989),
                            Description = "Can apply for jobs, deliver projects, and earn reputation.",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Freelancer",
                            UpdatedAt = new DateTime(2026, 3, 24, 6, 34, 16, 946, DateTimeKind.Utc).AddTicks(8989)
                        });
                });
