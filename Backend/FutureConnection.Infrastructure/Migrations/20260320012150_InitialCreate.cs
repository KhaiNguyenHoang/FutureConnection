        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeLanguageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CodeLanguages_CodeLanguages_CodeLanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FrameworkTypes_Frameworks_FrameworkId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a78b3f5c-1e9d-4c62-bb74-92a3d1e4f8c1"), new DateTime(2026, 3, 20, 1, 21, 49, 612, DateTimeKind.Utc).AddTicks(4913), "Full system administration access.", true, false, "Admin", new DateTime(2026, 3, 20, 1, 21, 49, 612, DateTimeKind.Utc).AddTicks(4913) },
                    { new Guid("b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e"), new DateTime(2026, 3, 20, 1, 21, 49, 612, DateTimeKind.Utc).AddTicks(4921), "Can post jobs, manage applications, and hire freelancers.", true, false, "Employer", new DateTime(2026, 3, 20, 1, 21, 49, 612, DateTimeKind.Utc).AddTicks(4921) },
                    { new Guid("c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f"), new DateTime(2026, 3, 20, 1, 21, 49, 612, DateTimeKind.Utc).AddTicks(4925), "Can apply for jobs, deliver projects, and earn reputation.", true, false, "Freelancer", new DateTime(2026, 3, 20, 1, 21, 49, 612, DateTimeKind.Utc).AddTicks(4925) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeLanguages_CodeLanguageId",
                table: "CodeLanguages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FrameworkTypes_FrameworkId",
